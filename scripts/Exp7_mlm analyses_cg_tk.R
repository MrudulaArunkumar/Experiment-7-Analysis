...
library(here)
write.csv(file = here("Data","DataForMLM.csv"),raw.data)
...
raw.data<-read.csv2(file="DataForMLM.csv")
...
randomSlopes_m1_err<-glmer(err_trials~1+val*sal + (1+ |participant), 
                           data=raw.data, 
                           na.action = "na.omit", binomial)
...
randomSlopes_m2<-lmer(RT_io~1+val*sal + previous_rm_cwp+ Distance_cwp + Distance_type_cwp +(1+val*sal + previous_rm_cwp + Distance_cwp + Distance_type_cwp|participant), 
                      data=raw.data, 
                      REML=F,
                      na.action = "na.omit")
...
randomSlopes_m4<-lmer(RT_io~1+val*sal + previous_rm_cwp*Distance_cwp*Distance_type_cwp +(1+val*sal + previous_rm_cwp*Distance_cwp*Distance_type_cwp|participant), 
                      data=raw.data, 
                      REML=F,
                      na.action = "na.omit")
...
randomSlopes_m4_err<-lmer(err_trials~1+val*sal + previous_rm_cwp*Distance_cwp*Distance_type_cwp +(1+val*sal + previous_rm_cwp*Distance_cwp*Distance_type_cwp|participant), 
                      data=raw.data, 
                      REML=F,
                      na.action = "na.omit")
...
randomSlopes_m5<-lmer(RT_io~1+val*sal + previous_rm_cwp+ Distance_cwp + Distance_type_cwp+
